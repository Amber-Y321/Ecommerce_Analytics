...
# -----------------------------------------------------------------------------
    ...
    st.subheader("2. Traffic quality by source")
    ...
    with col1:
        ...
        fig_source.update_layout(yaxis_tickformat=".1%")
    ...
    <ul>
        <li><b>High traffic + low conversion:</b> useful for awareness, but needs landing page or targeting improvement.</li>
        <li><b>Lower traffic + high conversion:</b> good candidate for budget increase because the audience shows purchase intent.</li>
        <li><b>Volatile traffic:</b> campaign timing or seasonal content may be driving temporary spikes.</li>
    </ul>
    </div>
    """, unsafe_allow_html=True)
